...
PROXIES_CONFIG = {
    ...
    # 包天代理
    'api_url': 'http://www.uu-ip.com/Tools/proxyIP.ashx?OrderNumber=1b45cb4f7dc8f73ee16f17ca2ba12adc&poolIndex=67530&cache=1&Split=JSON2&qty={}',
    'pool_size': 6,  # 代理池大小
    'time_out': 3 * 60,  # 代理ip超时时间
    'batch': 200,  # 接口最大请求数量
    'redis_key': 'proxy'  # redis中代理池的key
}
REDIS_CONN = {
